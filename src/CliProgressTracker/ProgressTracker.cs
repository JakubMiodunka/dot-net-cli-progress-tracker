...
/// const int Delay = 200;
/// 
/// using (var progressTracker = ProgressTracker.Regular(Steps))
/// {
...
public sealed class ProgressTracker : IDisposable
{
    ...
    public int CurrentStep
    {
        get
        {
            return _trackedProcess.CurrentStep;
        }
    }
    public int TotalSteps
    {
        get
        {
            return _trackedProcess.TotalSteps;
        }
    }
    public bool IsProcessComplete
    {
        get
        {
            return _trackedProcess.CurrentStep == _trackedProcess.TotalSteps;
        }
    }
    public DateTime RuntimeBegin
    {
        get
        {
            return _stopwatch.RuntimeBegin;
        }
    }
    public TimeSpan EstimatedRemainingRuntime
    {
        get
        {
            return _stopwatch.EstimatedRemainingRuntime;
        }
    }
    public DateTime EstimatedRuntimeFinish
    {
        get
        {
            return _stopwatch.EstimatedRuntimeFinish;
        }
    }
    public TimeSpan AverageTimePerStep
    {
        get
        {
            return _stopwatch.AverageTimePerStep;
        }
    }
    ...
    /// <summary>
    /// Updates displayed tracker representation by 1 step.
    /// </summary>
    public void Update()
    {
        Update(null, 1);
